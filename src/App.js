...
function App() {
	...
	return (
		<>
			...
			<FeatureAppModal visible={modalVisible} setVisible={setModalVisible} featureApp={featureApp} skills={skills} />
			<Profile githubData={githubData} />
			<Portfolio portfolio={portfolio} setModalVisible={setModalVisible} setFeatureApp={setFeatureApp} />
