...
const data = {
	career: [
		{
			company: "ARIS Technology",
			title: "Software Engineer",
			years: "September 2021 - Present",
			description: `I am currently working as a software engineer at ARIS Technology. During my time at ARIS, I have been heavily involved
	  with development and maintenance of the legacy ARIS software. I have also been leading the development of a new application that will
	  replace the legacy software. This new application is being built using React, Node, Python, C# and WebSockets for real-time data and 
	  communication with an emphasis on test driven development. The software integrates with a variety of hardware devices to provide a 
	  user-friendly interface for programming robotic measurement systems.`,
			location: "Chicago, IL",
		},
		{
			...
			description: `I was the lead design engineer for all new product development of new storage equipment at Aurora Storage Products, Inc (ASP). With
      all of my designs at ASP, I tried to consider manufacturability (DFMA), cost reduction, customer satisfaction, and safety of the
      finished products. I also gained hands-on experience prototyping and trouble shooting many of my new designs.`,
			location: "Aurora, IL",
		},
		{
	...
	portfolio: [
		{
			title: "Joistor",
			description: "A state management and schema validation library for JavaScript utilizing the Proxy API and the Joi npm package.",
			image: "joistor-low-resolution-logo-white-on-black-background.png",
			github_url: "https://github.com/michaelladouceur1/joistor",
			npm_url: "https://www.npmjs.com/package/joistor",
			technology: ["JavaScript", "Joi"],
			pinned: true,
		},
		{
			title: "Retro Draw",
